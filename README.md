...
<!--
**shivi-ki/shivi-ki** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
...
- 📫 How to reach me: ...
- 😄 Pronouns: ...
🔬 Neutrino Detector Simulator

  Interactive detector design platform
  Explore how geometry, detector medium, and sensor placement affect event detection
  Physics simulation + optimization + visualization

📊 PhysicsML

  Machine learning tools for scientific datasets
  Event classification and detector-performance prediction
- 
-->
